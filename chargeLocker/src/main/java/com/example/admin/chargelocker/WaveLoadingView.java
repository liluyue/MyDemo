...
public class WaveLoadingView extends View {
    ...
    private static final float DEFAULT_AMPLITUDE_VALUE = 20f;
    private static final float DEFAULT_WATER_LEVEL_RATIO = 0.5f;
    private static final float DEFAULT_WAVE_LENGTH_RATIO = 1.0f;
    private static final float DEFAULT_WAVE_SHIFT_RATIO = 0.0f;
    private static final int DEFAULT_WAVE_PROGRESS_VALUE = 50;
    private static final int DEFAULT_WAVE_COLOR = Color.parseColor("#0969CF");
    private static final int DEFAULT_TITLE_COLOR = Color.parseColor("#ff009688");
    ...
    public void onDraw(Canvas canvas) {
        ...
        for (int i=0;i<bubbles.size();i++) {
            Bubble bubble = bubbles.get(i);
                Bubble.top = (int) ((100 - mProgressValue) * getHeight()/100+100);
            bubble.draw(canvas);
        }
    }
...
//        mWaveShader = null;
    ...
    public void setProgressValue(int progress) {
        ...
        float defaultAmplitude = height * DEFAULT_AMPLITUDE_RATIO;
        mDefaultWaterLevel = height * DEFAULT_WATER_LEVEL_RATIO;
//        Bubble.top= (int) (mDefaultWaterLevel);
